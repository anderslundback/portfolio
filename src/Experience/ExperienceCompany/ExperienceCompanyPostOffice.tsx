            ...
            details={
                <>
                    <p>
                        ...
                        Primarily working on the Post Office Travel app which currently has over half a million users and
                        4.7 star reviews across both iOS and Android stores.
                </p>
                    <p>
                        The Post Office with its 11,600 branches nationwide is going through a digital revolution.
                        I'm part of the Customer Hub project which facilitates a single customer experience.
                        It enables customers to access accounts and services wherever and whenever they need to,
                        in a single journey, eliminating the disjointed journeys associated with multiple partners.
                    </p>
                </>
            }
        />
